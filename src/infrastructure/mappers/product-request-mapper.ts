...
import { PAGE_SIZE, productSearchParams } from "@/src/presentation/lib/product-search-params";
import type { ListProductsParams } from "@/src/infrastructure/repositories/product-repository";
