import {
  ...
  AuthUser,
  RegisterRequest,
} from "@/app/_domain/auth";
import {
  AuthSource,
  UserRegistrar,
} from "@/app/_application/_interfaces/auth-source";
import { StoredUserDTO } from "../_dtos/auth-dto";
import {
  getRegisteredUsers,
  setRegisteredUsers,
} from "@/app/_services/cookie-service";
import {
  createLocalToken,
  readLocalToken,
} from "@/app/_services/cookie-token-service";
